            ...
            <div className="container mx-auto lg:max-w-screen-xl md:max-w-screen-md px-4">
                ...
                <div className="max-w-6xl max-lg:max-w-3xl mx-auto">
                    <div className="rounded-xl">
                        <h2 className="text-3xl text-gray-800 font-bold text-center bg-white rounded-2xl py-6 mb-8 shadow-xl">Contactez-nous</h2>

                        <div className="grid lg:grid-cols-2 items-start gap-12">

                            <div className="space-y-3 text-gray-800 bg-white rounded-xl p-10 shadow-xl">
                                <div className="text-start mb-8">
                                    <h4 className="text-2xl font-bold mb-4">Une question, une idée, un projet en tête ? Parlons-en !</h4>
                                    <p>
                                        Que ce soit pour une collaboration, un échange d’idées ou simplement pour faire connaissance, nous serions ravis d’échanger avec vous. Laissez-nous un message via le formulaire ci-dessous, et nous vous répondrons au plus vite !
                                    </p>
                                </div>
                                <div className="flex items-start bg-white">
                                    <div className="flex items-center justify-center">
                                        <svg xmlns="http://www.w3.org/2000/svg" className="w-10 h-10 fill-blue-600" viewBox="0 0 512 512">
                                    ...
                                    <div className="ml-5">
                                        <p className="text-gray-500 mt-1">Antananarivo, Madagascar</p>
                                    </div>
                                </div>

                                <div className="flex items-start bg-white">
                                    <div className="flex items-center justify-center">
                                        <svg xmlns="http://www.w3.org/2000/svg" className="w-10 h-10 fill-blue-600" viewBox="0 0 473.806 473.806">
                                    ...
                                    <div className="ml-5">
                                        <p className=" text-gray-500 mt-1"> +261 3 08 635 34</p>
                                    </div>
                                </div>

                                <div className="flex items-start bg-white mt-8">
                                    <div className="flex items-center justify-center">
                                        <svg xmlns="http://www.w3.org/2000/svg" className="w-10 h-10 fill-blue-600" viewBox="0 0 32 32">
                                    ...
                                    <div className="ml-5">
                                        <p className="text-gray-500 mt-1">alexbrayanparker@gmail.com</p>
                                    </div>
                                </div>
                                <hr className="h-px my-8 bg-gray-200 border-0 my-8 dark:bg-gray-700"></hr>
                                {/* Social Media Icons */}
                            ...
                            <form className="space-y-4 text-gray-800 bg-white rounded-xl p-10 shadow-xl">
                                <input
                                    type="text"
                                    placeholder="Nom"
                                    name="name"
