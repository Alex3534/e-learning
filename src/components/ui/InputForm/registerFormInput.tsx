    ...
    return (
        <React.Fragment>
            <div className="w-full py-20 px-4 flex justify-center bg-gray-100">
                <div className="flex  max-w-6xl flex-col lg:flex-row shadow-lg rounded-lg bg-white">
                    ...
                    <form onSubmit={handleSubmit} className="bg-white lg:w-6/12 w-full space-y-6 p-10 py-20">
                        ...
                        <div>
                            <input
                                ...
                                className="w-full rounded-lg py-4 text-sm border bg-gray-50 px-3 focus:outline-none focus:ring-2 focus:ring-blue-500"
                            />
                        </div>
                        <div>
                            <input
                        ...
                        <div className="flex justify-center w-full">
                            <button
                                type="submit"
                                className="bg-blue-600 w-full py-3 px-8 mt-6 text-white border border-transparent hover:bg-white hover:text-blue-600 hover:border-blue-600 transition duration-300 rounded-lg"
                            >
                                Sign up
                            </button>
                        </div>
