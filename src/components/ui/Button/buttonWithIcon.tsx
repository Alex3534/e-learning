...
const SocialButton: React.FC<SocialButtontype> = ({ color, hoverColor, icon, label, focus }) => {
    return (
        <button
            type="button"
...
export const SignInWithFacebook: React.FC<{ label: string }> = ({ label }) => {
    return (
        <React.Fragment>
            <SocialButton
                color="blue-600"
...
export const SignInWithTwiter: React.FC<{ label: string }> = ({ label }) => {
    return (
        <React.Fragment>
            <SocialButton
                color="blue-600"
...
export const SignInWithGitHub: React.FC<{ label: string }> = ({ label }) => {
    return (
        <React.Fragment>
            <button
                type="button"
...
export const SignInWithGoogle: React.FC<{ label: string }> = ({ label }) => {
    return (
        <React.Fragment>
            <button
                type="button"
...
export const SignInWithApple: React.FC<{ label: string }> = ({ label }) => {
    return (
        <React.Fragment>
            <button
                type="button"
...
export const ConnectWithMetaMask: React.FC<{ label: string }> = ({ label }) => {
    return (
        <React.Fragment>
...
export const EditButton: React.FC<{ label: string }> = ({ label }) => {
    return (
        <button
            type="button"
...
export const DownloadButton: React.FC<{ label: string }> = ({ label }) => {
    return (
        <button
            type="button"
