...
export const ButtonOutlineGradientCyanToBlue: React.FC<{ label: string }> = ({ label }) => {
    return (
        <React.Fragment>
            ...
            >
                <span
                    className="px-5 py-2.5 transition-all ease-in duration-75 bg-white rounded-md group-hover:bg-transparent"
                >
                    Cyan to blue
                </span>
            </button>
...
export const ButtonOutlineGradientRedToYellow: React.FC<{ label: string }> = ({ label }) => {
    return (
        <React.Fragment>
            ...
            >
                <span className="px-5 py-2.5 transition-all ease-in duration-300 bg-white rounded-md group-hover:bg-transparent">
                    Red to Yellow
                </span>
            </button>
        </React.Fragment>
