...
const SocialButton = ({ color, hoverColor, icon, label, focus }) => {
    return (
        <button
            type="button"
            className={\`text-\${hoverColor} bg-\${color} hover:bg-\${hoverColor} focus:ring-4 focus:outline-none focus:ring-\${focus} font-medium rounded-lg text-sm px-5 hover:text-\${color} py-2.5 text-center inline-flex items-center me-2 mb-2 border border-transparent hover:border-\${color} transition duration-300 \`}>
            {icon}
            {label}
        </button>
    )
...
export const SignInWithFacebook = ({ label }) => {
    return (
        <React.Fragment>
            <SocialButton
                color="blue-600"
...
export const SignInWithTwiter = ({ label }) => {
    return (
        <React.Fragment>
            <SocialButton
                color="blue-600"
...
export const SignInWithGitHub = ({ label }) => {
    return (
        <React.Fragment>
            <button
                type="button"
                className="transition duration-300 text-white bg-gray-700 hover:bg-white hover:text-gray-900 focus:ring-4 focus:outline-none focus:ring-gray-400 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center border border-transparent hover:border-gray-900 me-2 mb-2"
            >
                <svg
                    className="w-4 h-4 me-2"
                    aria-hidden="true"
...
export const SignInWithGoogle = ({ label }) => {
    return (
        <React.Fragment>
            <button
                type="button"
                className="text-white hover:text-blue-500 bg-blue-500 border border-transparent hover:border-blue-500 transition duration-300
            hover:bg-white focus:ring-4 focus:outline-none focus:ring-blue-200 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center me-2 mb-2">
                <svg
                    className="w-4 h-4 me-2"
                    aria-hidden="true"
...
export const SignInWithApple = ({ label }) => {
    return (
        <React.Fragment>
            <button
                type="button"
                className="text-white hover:text-gray-800 bg-gray-800 border border-transparent hover:border-gray-900 transition duration-300
            hover:bg-white focus:ring-4 focus:outline-none focus:ring-blue-200 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center me-2 mb-2">
                <svg
...
export const ConnectWithMetaMask = ({ label }) => {
    return (
        <React.Fragment>
...
export const EditButton = ({ label }) => {
    return (
        <button
            type="button"
            className="text-white hover:text-blue-600 bg-blue-600 border border-transparent hover:border-blue-500 transition duration-300
            hover:bg-white focus:ring-4 focus:outline-none focus:ring-blue-200 font-medium rounded-lg text-sm px-5 py-1 text-center inline-flex items-center me-2 mb-2">
            <svg
...
export const DownloadButton = ({ label }) => {
    return (
        <button
            type="button"
            className="text-white hover:text-blue-500 bg-blue-600 border border-transparent hover:border-blue-500 transition duration-300
            hover:bg-white focus:ring-4 focus:outline-none focus:ring-blue-200 font-medium rounded-lg text-sm px-5 py-1 text-center inline-flex items-center me-2 mb-2">
            <svg
                className="w-6 h-6 me-2"
                aria-hidden="true"
...
export const SignInWithGitHub = ({ label = 'Sign in with Github', ...props }) => {
  return (
    <React.Fragment>
      <button
        {...props}
        type="button"
        className="transition cursor-pointer duration-300 text-white bg-gray-700 hover:bg-white hover:text-gray-900 focus:ring-4 focus:outline-none focus:ring-gray-400 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center border border-transparent hover:border-gray-900 m-2"
      >
        <svg
          className="w-4 h-4 me-2"
          aria-hidden="true"
...
export const SignInWithFacebook = ({ label = 'Sign in with Facebook', ...props }) => {
  return (
    <React.Fragment>
      <button
        {...props}
        type="button"
        className="text-white cursor-pointer hover:text-blue-500 bg-blue-500 border border-transparent hover:border-blue-500 transition duration-300
            hover:bg-white focus:ring-4 focus:outline-none focus:ring-blue-200 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center m-2">
        <svg
          className="w-4 h-4 me-2"
          aria-hidden="true"
          xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 8 19">
...
export const SignInWithTwiter = ({ label = 'Sign in with Twiter', ...props }) => {
  return (
    <React.Fragment>
      <button
        {...props}
...
export const SignInWithGoogle = ({ label = 'Sign in with Google', ...props }) => {
  return (
    <React.Fragment>
      <button
        {...props}
...
export const SignInWithApple = ({ label = 'Sign in with Apple', ...props }) => {
  return (
    <React.Fragment>
      <button
        {...props}
        type="button"
        className="text-white cursor-pointer hover:text-gray-800 bg-gray-800 border border-transparent hover:border-gray-900 transition duration-300
            hover:bg-white focus:ring-4 focus:outline-none focus:ring-blue-200 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center m-2">
        <svg
          className="w-5 h-5 me-2 -ms-1"
          aria-hidden="true"
...
export const ConnectWithMetaMask = ({ label = 'Connect with MetaMask', ...props }) => {
  return (
    <React.Fragment>
      <button
        {...props}
        type="button"
        className="cursor-pointer text-gray-900 bg-white hover:bg-gray-100 border border-gray-200 focus:ring-4 focus:outline-none focus:ring-gray-100 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center  m-2"
      >
...
export const EditButton = ({ label = 'Edit' }) => {
  return (
    <button
      type="button"
      className="cursor-pointer text-white hover:text-blue-600 bg-blue-600 border border-transparent hover:border-blue-500 transition duration-300
            hover:bg-white focus:ring-4 focus:outline-none focus:ring-blue-200 font-medium rounded-lg text-sm px-5 py-2 text-center inline-flex items-center m-2">
      <svg
        className="w-6 h-6 me-2"
        aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
...
export const DownloadButton = ({ label = 'Download', ...props }) => {
  return (
    <button
      {...props}
      type="button"
      className="cursor-pointer text-white hover:text-blue-500 bg-blue-600 border border-transparent hover:border-blue-500 transition duration-300
            hover:bg-white focus:ring-4 focus:outline-none focus:ring-blue-200 font-medium rounded-lg text-sm px-5 py-2 text-center inline-flex items-center m-2">
      <svg
        className="w-6 h-6 me-2"
        aria-hidden="true"
...
// app/page.jsx
import React from "react";
import { ConnectWithMetaMask, DownloadButton, EditButton, SignInWithApple, SignInWithFacebook, SignInWithGitHub, SignInWithGoogle, SignInWithTwiter } from "./components/button";
