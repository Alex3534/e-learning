...
import { ComponentModaltData } from '@/data/componentModalData';
import { ComponentTooltipstData } from '@/data/componentTooltipsData';
...
export default function ComponentTooltipPage() {
    ...
    const filteredComponents = ComponentTooltipstData.filter((component) => {
